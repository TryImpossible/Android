...
import com.barry.service.IPayInterface;

import java.util.List;

public class RemotePayActivity extends Activity {

    private IPayInterface iPay;

    private ServiceConnection conn = new ServiceConnection() {
        @Override
        public void onServiceConnected(ComponentName name, IBinder service) {
            iPay = IPayInterface.Stub.asInterface(service);
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent.setAction("com.barry.pay");
